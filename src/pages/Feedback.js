  ...
  const slides = [
    {
      ...
      feedback: (
        <p>
          ...
          моих целей(набор мышечной массы, улучшение настроения и общего
          состояния здоровья). Евгения помогла мне провести анализ моего рациона
          питания, выявить ненужные продукты и внести коррективы. Её глубокие
          знания в области нутрициологии позволили ей точно определить, какие
          продукты следует исключить из моего рациона, а какие добавить для
